...
const TRANSLATIONS = {
    ...
    HI: {
        ...
        "⚙️ Edit Shortcuts": "⚙️ शॉर्टकट बदलें",
        "Customize Fast-Log Shortcuts": "त्वरित खर्च शॉर्टकट कस्टमाइज़ करें",
        "Set your most frequent daily expenses (like Chai, Lunch, Fuel, Milk) for 1-tap fast logging.": "1-टैप फास्ट लॉगिंग के लिए अपने दैनिक खर्च (जैसे चाय, लंच, पेट्रोल, दूध) सेट करें।",
        "+ Add New Shortcut": "+ नया शॉर्टकट जोड़ें",
        "🔄 Reset Defaults": "🔄 डिफ़ॉल्ट रीसेट करें",
        "💾 Save Shortcuts": "💾 शॉर्टकट सेव करें",
